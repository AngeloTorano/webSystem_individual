      ...
      <div class="container bg-secondary">
        <div class="containerX ">
          <div class="row featurette">
            <div class="col-md-7 ">
              <h1 class="featurette-heading fw-normal lh-1"><center>Rush Hour</center><span class="text-body-secondary"></span></h1>
              <div class="content m-5 p-5">
                <p class="lead">When a Chinese diplomat's daughter is kidnapped in Los Angeles, he
                  calls in Hong Kong Detective Inspector Lee (Jackie Chan) to assist the
                  FBI with the case. But the FBI doesn't want anything to do with Lee,
                  and they dump him off on the LAPD, who assign wisecracking
                  ...
                  ditched by both the FBI and police.
            ...
            <div class="col-md-5">
              ...
              <image height="500" width="500" href="img/comedy.jpg" />
            </svg>
            <a type="submit" class="btn btn-light mt-3 w-100" href="https://youtu.be/JMiFsFQcFLE?si=PfPico01LZgd3G1j">Watch Now</a>
            </div>
