      ...
      <div class="container bg-secondary">
        <div class="containerX ">
          <div class="row featurette">
            <div class="col-md-7 ">
              <h1 class="featurette-heading fw-normal lh-1"><center>Train to Busan
              </center><span class="text-body-secondary"></span></h1>
              <div class="content m-5 p-5">
                <p class="lead">The film mostly takes place on a KTX train from Seoul to Busan as a
                  zombie apocalypse suddenly breaks out in the country, threatening
                  the safety of the passengers. The film premiered in the Midnight
                  Screenings section of the 2016 Cannes Film Festival on May 13.
                </p>
              </div>
            ...
            <div class="col-md-5">
              ...
              <image height="500" width="500" href="img/thriller.jpg" />
            </svg>
            <a type="submit" class="btn btn-light mt-3 w-100" href="https://youtu.be/1ovgxN2VWNc?si=-wtwMhI7rbnK5kmz">Watch Now</a>
            </div>
