      ...
      <div class="container bg-secondary">
        <div class="containerX ">
          <div class="row featurette">
            <div class="col-md-7 ">
              <h1 class="featurette-heading fw-normal lh-1"><center>Interstellar
              </center><span class="text-body-secondary"></span></h1>
              <div class="content m-5 p-5">
                <p class="lead">In Earth's future, a global crop blight and a second Dust Bowl are
            ...
            <div class="col-md-5">
              ...
              <image height="500" width="500" href="img/sci-fic.jpg" />
            </svg>
            <a type="submit" class="btn btn-light mt-3 w-100" href="https://youtu.be/2LqzF5WauAw?si=4CPOHLUxqCzznTCr">Watch Now</a>
            </div>
